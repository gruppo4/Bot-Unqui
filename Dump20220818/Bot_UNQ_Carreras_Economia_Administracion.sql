...
--
-- Table structure for table `Carreras_Economia_Administracion`
--

DROP TABLE IF EXISTS `Carreras_Economia_Administracion`;
...
--
-- Dumping data for table `Carreras_Economia_Administracion`
--

LOCK TABLES `Carreras_Economia_Administracion` WRITE;
/*!40000 ALTER TABLE `Carreras_Economia_Administracion` DISABLE KEYS */;
/*!40000 ALTER TABLE `Carreras_Economia_Administracion` ENABLE KEYS */;
UNLOCK TABLES;
