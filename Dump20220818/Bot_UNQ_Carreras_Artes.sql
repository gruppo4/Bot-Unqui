...
--
-- Table structure for table `Carreras_Artes`
--

DROP TABLE IF EXISTS `Carreras_Artes`;
...
--
-- Dumping data for table `Carreras_Artes`
--

LOCK TABLES `Carreras_Artes` WRITE;
/*!40000 ALTER TABLE `Carreras_Artes` DISABLE KEYS */;
/*!40000 ALTER TABLE `Carreras_Artes` ENABLE KEYS */;
UNLOCK TABLES;
