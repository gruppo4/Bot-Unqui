...
--
-- Table structure for table `Carreras_Ciencias_Sociales`
--

DROP TABLE IF EXISTS `Carreras_Ciencias_Sociales`;
...
--
-- Dumping data for table `Carreras_Ciencias_Sociales`
--

LOCK TABLES `Carreras_Ciencias_Sociales` WRITE;
/*!40000 ALTER TABLE `Carreras_Ciencias_Sociales` DISABLE KEYS */;
/*!40000 ALTER TABLE `Carreras_Ciencias_Sociales` ENABLE KEYS */;
UNLOCK TABLES;
